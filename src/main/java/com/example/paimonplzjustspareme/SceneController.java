...
public class SceneController {
    ...
    public void switchToActionChoice2(ActionEvent event) throws IOException {
        ...
        stage = (Stage) ((Node) event.getSource()).getScene().getWindow();
        Scene PaimonvsSlime = new Scene(root, 600, 500);
        ...
        Fight.setLayoutY(375);
        Fight.setPrefHeight(50);
        Fight.setPrefWidth(100);
        root.getChildren().addAll(background, Fight);
        stage.show();
        ...
        Fight.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent event) {
                Parent root = null;
                try {
                    root = FXMLLoader.load(getClass().getResource("PaimonVSSlimetext.fxml"));
                } catch (IOException e) {
    ...
    public void SlimeStats(ActionEvent event) throws IOException {
        ...
        stats.setX(800);
        stats.setY(200);
        ImageView PaimonHi = new ImageView("Slimes-removebg-preview.png");
        PaimonHi.setY(100);
        PaimonHi.setX(-75);
